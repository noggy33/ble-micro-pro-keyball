...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------.                    `--------+--------+--------+--------+--------+--------|
      KC_LCTL,KC_AL_CP,         KC_L_SPC, KC_S_EN, KC_A_JA,                     KC_R_ENT,KC_G_DEL,                            KC_PSCR
  //`--------+--------'        `--------+---------+-------'                     `--------+--------'                         `--------'
  ),
  ...
  //|--------+--------+--------+--------+--------+--------'                    |--------+--------+--------+--------+--------+--------|
      KC_SLSH,    KC_1,    KC_2,    KC_3,  KC_EQL, _______,                      _______, _______, KC_DOWN, _______, _______, _______,
  //|--------+--------+--------+--------+--------+--------.                    `--------+--------+--------+--------+--------+--------|
      KC_LCTL,KC_AL_CP,         KC_L_SPC, KC_S_EN, KC_A_JA,                     KC_R_ENT,KC_G_DEL,                            KC_PSCR
  //`--------+--------'        `--------+---------+-------'                     `--------+--------'                         `--------'
  ),
  ...
  //|--------+--------+--------+--------+--------+--------'                    |--------+--------+--------+--------+--------+--------|
       KC_GRV,  KC_DQT, KC_QUOT, KC_CIRC, KC_TILD, _______,                      _______, _______, KC_PGDN, _______, _______, _______,
  //|--------+--------+--------+--------+--------+--------.                    `--------+--------+--------+--------+--------+--------|
      KC_LCTL,KC_AL_CP,         KC_L_SPC, KC_S_EN, KC_A_JA,                     KC_R_ENT,KC_G_DEL,                            KC_PSCR
  //`--------+--------'        `--------+---------+-------'                     `--------+--------'                         `--------'
  ),
